...
export default function Home() {
  ...
  return (
    <div className="relative min-h-full overflow-hidden bg-background">
      ...
      <svg
        className="pointer-events-none absolute right-[-200px] top-[-140px] h-[600px] w-[900px] opacity-70"
                ...
                {streamItems.map((item) => (
                  ...
                  >
                    ...
                    <div className="mt-3 h-1 w-full rounded-full bg-muted">
                      <div className="shimmer h-full w-2/3 rounded-full bg-linear-to-r from-amber-500/65 via-orange-500/55 to-yellow-500/65" />
                    </div>
                  </div>
                ))}
              </div>
